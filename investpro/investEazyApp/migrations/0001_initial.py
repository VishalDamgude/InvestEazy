    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='investEazyApp.investor')),
                ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='investEazyApp.stock')),
            ],
        ),
        migrations.CreateModel(
            name='Investment',
